...
const About = () => {
  return (
    ...
    <section id="about"
      class="flex items-center bg-stone-100 xl:h-screen mx-10 font-poppins dark:bg-gray-800"
    >
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0">
            <div class="pl-4 mb-6 border-l-4 border-blue-500">
              ...
              >
              <h1
                class="mt-2 text-3xl font-black text-gray-700 md:text-5xl dark:text-gray-300"
              >
                About Us
              </h1>
            </div>
            <p
              class="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400"
            >
